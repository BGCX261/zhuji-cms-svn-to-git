<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="ChannelManage.ascx.cs" Inherits="ZhuJi.Portal.WebUI.DesktopModule.CommonModule.ChannelManage"  %>
<%@ Register Src="ChannelList.ascx" TagName="ChannelList" TagPrefix="uc1" %>
<%@ Register Src="ChannelEdit.ascx" TagName="ChannelEdit" TagPrefix="uc2" %>
...
<fieldset>
    ...
    <uc1:ChannelList id="ChannelList1" runat="server"></uc1:ChannelList>
</fieldset>
</asp:Panel>
...
<fieldset>
    ...
    <uc2:ChannelEdit Id="ChannelEdit1" runat="server" />
</fieldset>
</asp:Panel>
