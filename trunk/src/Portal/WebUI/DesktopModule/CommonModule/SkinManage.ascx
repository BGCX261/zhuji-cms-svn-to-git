<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="SkinManage.ascx.cs" Inherits="ZhuJi.Portal.WebUI.DesktopModule.CommonModule.SkinManage"  %>
<%@ Register Src="SkinList.ascx" TagName="SkinList" TagPrefix="uc1" %>
<%@ Register Src="SkinEdit.ascx" TagName="SkinEdit" TagPrefix="uc2" %>
...
<fieldset>
    ...
    <uc1:SkinList id="SkinList1" runat="server" OrderNo="tmp.OrderBy,tmp.Id"></uc1:SkinList>
</fieldset>
</asp:Panel>
...
<fieldset>
    ...
    <uc2:SkinEdit Id="SkinEdit1" runat="server" />
</fieldset>
</asp:Panel>
