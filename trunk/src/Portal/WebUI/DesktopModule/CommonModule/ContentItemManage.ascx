<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="ContentItemManage.ascx.cs" Inherits="ZhuJi.Portal.WebUI.DesktopModule.CommonModule.ContentItemManage"  %>
<%@ Register Src="ContentItemList.ascx" TagName="ContentItemList" TagPrefix="uc1" %>
<%@ Register Src="ContentItemEdit.ascx" TagName="ContentItemEdit" TagPrefix="uc2" %>
...
<fieldset>
    ...
    <uc1:ContentItemList id="ContentItemList1" runat="server" OrderNo="tmp.OrderBy,tmp.Id"></uc1:ContentItemList>
</fieldset>
</asp:Panel>
...
<fieldset>
    ...
    <uc2:ContentItemEdit Id="ContentItemEdit1" runat="server" />
</fieldset>
</asp:Panel>
