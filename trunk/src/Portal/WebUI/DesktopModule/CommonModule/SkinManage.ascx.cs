...
{
    public partial class SkinManage : ZhuJi.Portal.WebUI.BaseWebControl
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            SkinEdit1.Command = "ADD";
            SkinEdit1.Initialize();
        }
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Initialize();
            pnlEdit.Visible = true;
            SkinEdit1.Identity = int.Parse(id);
            SkinEdit1.Command = "EDIT";
            SkinEdit1.Initialize();
        }
