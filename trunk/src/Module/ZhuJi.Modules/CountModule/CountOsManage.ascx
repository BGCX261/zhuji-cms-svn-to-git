<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountOsManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountOsManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountOsList.ascx" TagName="CountOsList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountOsList id="CountOsList1" runat="server"></uc1:CountOsList>
</fieldset>
</asp:Panel>