<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountResolutionManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountResolutionManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountResolutionList.ascx" TagName="CountResolutionList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountResolutionList id="CountResolutionList1" runat="server"></uc1:CountResolutionList>
</fieldset>
</asp:Panel>
