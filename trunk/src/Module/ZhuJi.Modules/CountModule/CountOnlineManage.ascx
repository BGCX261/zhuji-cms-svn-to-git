<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountOnlineManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountOnlineManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountOnlineList.ascx" TagName="CountOnlineList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountOnlineList id="CountOnlineList1" runat="server"></uc1:CountOnlineList>
</fieldset>
</asp:Panel>
