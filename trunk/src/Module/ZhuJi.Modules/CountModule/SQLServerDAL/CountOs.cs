...
namespace ZhuJi.Modules.CountModule.SQLServerDAL
{
	...
	/// 统计操作系统数据层
	/// </summary>
	public class CountOs : ZhuJi.Modules.CountModule.IDAL.ICountOs
	{
		/// <summary>
		/// 获取记录集合
		/// </summary>
		...
		public virtual DataSet GetObjects(DateTime beginTime, DateTime endTime)
		{
			...
			return SqlHelper.ExecuteDataSet(DBFactory.DBConnectionString, CommandType.StoredProcedure, "CountOs_Query", "CountOs", cmdParms);
		}
	}
}
