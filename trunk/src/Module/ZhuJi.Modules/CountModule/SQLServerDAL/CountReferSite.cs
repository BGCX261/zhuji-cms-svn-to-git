...
namespace ZhuJi.Modules.CountModule.SQLServerDAL
{
	...
	/// 统计来路站点数据层
	/// </summary>
	public class CountReferSite : ZhuJi.Modules.CountModule.IDAL.ICountReferSite
	{
		/// <summary>
		/// 获取记录集合
		/// </summary>
		...
		public virtual DataSet GetObjects(DateTime beginTime, DateTime endTime)
		{
			...
			return SqlHelper.ExecuteDataSet(DBFactory.DBConnectionString, CommandType.StoredProcedure, "CountReferSite_Query", "CountReferSite", cmdParms);
		}
	}
}
