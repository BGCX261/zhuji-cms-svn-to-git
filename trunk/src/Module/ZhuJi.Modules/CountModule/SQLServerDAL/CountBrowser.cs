...
namespace ZhuJi.Modules.CountModule.SQLServerDAL
{
	...
	/// 统计浏览器数据层
	/// </summary>
    public class CountBrowser : ZhuJi.Modules.CountModule.IDAL.ICountBrowser
    {
		/// <summary>
		/// 获取记录集合
		/// </summary>
		...
		public virtual DataSet GetObjects(DateTime beginTime, DateTime endTime)
		{
			...
			return SqlHelper.ExecuteDataSet(DBFactory.DBConnectionString, CommandType.StoredProcedure, "CountBrowser_Query", "CountBrowser", cmdParms);
		}
    }
}
