...
namespace ZhuJi.Modules.CountModule.SQLServerDAL
{
	...
	/// 统计受访页数据层
	/// </summary>
	public class CountRespondents : ZhuJi.Modules.CountModule.IDAL.ICountRespondents
	{
		/// <summary>
		/// 获取记录集合
		/// </summary>
		...
		public virtual DataSet GetObjects(DateTime beginTime, DateTime endTime)
		{
			...
			return SqlHelper.ExecuteDataSet(DBFactory.DBConnectionString, CommandType.StoredProcedure, "CountRespondents_Query", "CountRespondents", cmdParms);
		}
	}
}
