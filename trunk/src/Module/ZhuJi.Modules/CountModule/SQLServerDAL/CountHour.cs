...
namespace ZhuJi.Modules.CountModule.SQLServerDAL
{
	...
	/// 统计时段数据层
	/// </summary>
    public class CountHour : ZhuJi.Modules.CountModule.IDAL.ICountHour
    {
		/// <summary>
		/// 获取记录集合
		/// </summary>
		...
		public virtual DataSet GetObjects(DateTime beginTime, DateTime endTime)
		{
			...
			return SqlHelper.ExecuteDataSet(DBFactory.DBConnectionString, CommandType.StoredProcedure, "CountHour_Query", "CountHour", cmdParms);
		}
    }
}
