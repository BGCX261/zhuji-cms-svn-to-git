...
namespace ZhuJi.Modules.CountModule.SQLServerDAL
{
	...
	/// 统计来路页面数据层
	/// </summary>
	public class CountReferUrl : ZhuJi.Modules.CountModule.IDAL.ICountReferUrl
	{
		/// <summary>
		/// 获取记录集合
		/// </summary>
		...
		public virtual DataSet GetObjects(DateTime beginTime, DateTime endTime)
		{
			...
			return SqlHelper.ExecuteDataSet(DBFactory.DBConnectionString, CommandType.StoredProcedure, "CountReferUrl_Query", "CountReferUrl", cmdParms);
		}
	}
}
