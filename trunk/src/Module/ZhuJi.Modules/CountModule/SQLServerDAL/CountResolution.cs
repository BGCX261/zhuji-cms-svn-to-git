...
namespace ZhuJi.Modules.CountModule.SQLServerDAL
{
	...
	/// 统计分辨率数据层
	/// </summary>
	public class CountResolution : ZhuJi.Modules.CountModule.IDAL.ICountResolution
	{
		/// <summary>
		/// 获取记录集合
		/// </summary>
		...
		public virtual DataSet GetObjects(DateTime beginTime, DateTime endTime)
		{
			...
			return SqlHelper.ExecuteDataSet(DBFactory.DBConnectionString, CommandType.StoredProcedure, "CountResolution_Query", "CountResolution", cmdParms);
		}
	}
}
