<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountBrowserManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountBrowserManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountBrowserList.ascx" TagName="CountBrowserList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountBrowserList id="CountBrowserList1" runat="server"></uc1:CountBrowserList>
</fieldset>
</asp:Panel>
