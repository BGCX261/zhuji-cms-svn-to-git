<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountHourManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountHourManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountHourList.ascx" TagName="CountHourList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountHourList id="CountHourList1" runat="server"></uc1:CountHourList>
</fieldset>
</asp:Panel>
