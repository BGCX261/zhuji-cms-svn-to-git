<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountBackManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountBackManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountBackList.ascx" TagName="CountBackList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountBackList id="CountBackList1" runat="server"></uc1:CountBackList>
</fieldset>
</asp:Panel>