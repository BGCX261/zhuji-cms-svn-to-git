<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountReferUrlManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountReferUrlManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountReferUrlList.ascx" TagName="CountReferUrlList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountReferUrlList id="CountReferUrlList1" runat="server"></uc1:CountReferUrlList>
</fieldset>
</asp:Panel>
