<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountAreaManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountAreaManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountAreaList.ascx" TagName="CountAreaList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountAreaList id="CountAreaList1" runat="server"></uc1:CountAreaList>
</fieldset>
</asp:Panel>
