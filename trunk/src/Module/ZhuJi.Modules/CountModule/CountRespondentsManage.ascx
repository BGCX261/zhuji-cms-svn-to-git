<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CountRespondentsManage.ascx.cs" Inherits="ZhuJi.Modules.CountModule.WebUI.CountRespondentsManage"  %>
<%@ Register Assembly="ZhuJi.Component" Namespace="ZhuJi.Component" TagPrefix="cc1" %>
<%@ Register Src="CountRespondentsList.ascx" TagName="CountRespondentsList" TagPrefix="uc1" %>
...
<fieldset>
    ...
    <uc1:CountRespondentsList id="CountRespondentsList1" runat="server"></uc1:CountRespondentsList>
</fieldset>
</asp:Panel>
