...
{
    public partial class AdsLocationList : ZhuJi.Portal.WebUI.BaseWebControl
    {
        ...
        public void List()
        {
            try
            {
                ...
                rptList.DataSource = adsLocation.GetObjects(base.Where, base.OrderNo, base.PageNo, base.PageSize);
                rptList.DataBind();
                if (base.IsShowPager)
                {
                    ...
                    simplePager.RecordCount = adsLocation.GetRowCount;
