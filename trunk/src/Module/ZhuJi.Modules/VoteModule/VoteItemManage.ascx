<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="VoteItemManage.ascx.cs" Inherits="ZhuJi.Modules.VoteModule.WebUI.VoteItemManage"  %>
<%@ Register Src="VoteItemList.ascx" TagName="VoteItemList" TagPrefix="uc1" %>
<%@ Register Src="VoteItemEdit.ascx" TagName="VoteItemEdit" TagPrefix="uc2" %>
...
<fieldset>
    ...
    <uc1:VoteItemList id="VoteItemList1" runat="server"></uc1:VoteItemList>
</fieldset>
</asp:Panel>
...
<fieldset>
    ...
    <uc2:VoteItemEdit Id="VoteItemEdit1" runat="server" />
</fieldset>
</asp:Panel>
