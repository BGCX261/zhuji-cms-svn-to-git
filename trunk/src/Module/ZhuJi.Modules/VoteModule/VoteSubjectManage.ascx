<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="VoteSubjectManage.ascx.cs" Inherits="ZhuJi.Modules.VoteModule.WebUI.VoteSubjectManage"  %>
<%@ Register Src="VoteSubjectList.ascx" TagName="VoteSubjectList" TagPrefix="uc1" %>
<%@ Register Src="VoteSubjectEdit.ascx" TagName="VoteSubjectEdit" TagPrefix="uc2" %>
...
<fieldset>
    ...
    <uc1:VoteSubjectList id="VoteSubjectList1" runat="server"></uc1:VoteSubjectList>
</fieldset>
</asp:Panel>
...
<fieldset>
    ...
    <uc2:VoteSubjectEdit Id="VoteSubjectEdit1" runat="server" />
</fieldset>
</asp:Panel>
