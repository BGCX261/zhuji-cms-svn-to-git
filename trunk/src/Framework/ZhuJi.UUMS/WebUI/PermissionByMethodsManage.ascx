<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="PermissionByMethodsManage.ascx.cs" Inherits="ZhuJi.UUMS.WebUI.PermissionByMethodsManage"  %>
<%@ Register Src="PermissionByMethodsList.ascx" TagName="PermissionByMethodsList" TagPrefix="uc1" %>
<%@ Register Src="PermissionByMethodsEdit.ascx" TagName="PermissionByMethodsEdit" TagPrefix="uc2" %>
...
<fieldset>
    ...
    <uc1:PermissionByMethodsList id="PermissionByMethodsList1" runat="server"></uc1:PermissionByMethodsList>
</fieldset>
</asp:Panel>
...
<fieldset>
    ...
    <uc2:PermissionByMethodsEdit Id="PermissionByMethodsEdit1" runat="server" />
</fieldset>
</asp:Panel>
