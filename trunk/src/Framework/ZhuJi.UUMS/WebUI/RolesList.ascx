<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="RolesList.ascx.cs" Inherits="ZhuJi.UUMS.WebUI.RolesList" %>
<asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="gvList_RowCancelingEdit"
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="角色名称">
			<EditItemTemplate>
				<asp:TextBox ID="txtRoleName" runat="server" Text='<%# Bind("RoleName") %>' Width="300px"></asp:TextBox>
			</EditItemTemplate>
			<ItemTemplate>
	...
	<HeaderStyle Height="30px" CssClass="nfgridheader" />
</asp:GridView>