<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="UsersManage.ascx.cs" Inherits="ZhuJi.UUMS.WebUI.UsersManage"  %>
<%@ Register Src="UsersList.ascx" TagName="UsersList" TagPrefix="uc1" %>
<%@ Register Src="UsersEdit.ascx" TagName="UsersEdit" TagPrefix="uc2" %>
...
<fieldset>
    ...
    <uc1:UsersList id="UsersList1" runat="server"></uc1:UsersList>
</fieldset>
</asp:Panel>
...
<fieldset>
    ...
    <uc2:UsersEdit Id="UsersEdit1" runat="server" />
</fieldset>
</asp:Panel>
