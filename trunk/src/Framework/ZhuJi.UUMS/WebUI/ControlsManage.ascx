<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="ControlsManage.ascx.cs" Inherits="ZhuJi.UUMS.WebUI.ControlsManage"  %>
<%@ Register Src="ControlsList.ascx" TagName="ControlsList" TagPrefix="uc1" %>
<%@ Register Src="ControlsEdit.ascx" TagName="ControlsEdit" TagPrefix="uc2" %>
...
<fieldset>
    ...
    <uc1:ControlsList id="ControlsList1" runat="server"></uc1:ControlsList>
</fieldset>
</asp:Panel>
...
<fieldset>
    ...
    <uc2:ControlsEdit Id="ControlsEdit1" runat="server" />
</fieldset>
</asp:Panel>
