<%@ Control Language="C#" AutoEventWireup="True" Codebehind="MethodExplainList.ascx.cs"
    Inherits="ZhuJi.UUMS.WebUI.MethodExplainList" %>
<asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="gvList_RowCancelingEdit"
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="说明">
			<EditItemTemplate>
				<asp:TextBox ID="txtTitle" runat="server" Text='<%# Bind("Title") %>' Width="300px"></asp:TextBox>
			</EditItemTemplate>
			<ItemTemplate>
