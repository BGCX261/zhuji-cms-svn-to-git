...
using ZhuJi.Modules.CountModule.NHibernateDAL;
using Microsoft.VisualStudio.TestTools.UnitTesting.Web;
namespace ZhuJi.Test.Modules.CountModule.NHibernateDAL
{
	/// <summary>
	///这是 ZhuJi.Modules.CountModule.NHibernateDAL.CountStat 的测试类，旨在
	///包含所有 ZhuJi.Modules.CountModule.NHibernateDAL.CountStat 单元测试
	///</summary>
	[TestClass()]
